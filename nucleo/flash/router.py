    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "add_meeting = un evento con fecha/hora, y CREA SOLO su aviso por defecto (~2h antes) — no lo "
                "dupliques con un cron; si el operador quiere el aviso a OTRA hora («avísame a mediodía»), es "
                "widget_data set_reminder sobre esa cita, nunca otra add_meeting. [[cron.create]] queda para "
                "avisos SUELTOS sin cita detrás. Para un item "
