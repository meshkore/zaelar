...
# ── OPENING A CARD IS NOT DELIVERING A RESULT (V2-209) — extracted to `surface_ack.py` (ratchet, 2026-09-05).
# Historical names stay as ALIASES; the measured story lives with the code.
from nucleo.flash.surface_ack import nothing_to_show, show_ack  # noqa: F401 — re-export, not a local use
