...
TOOLS: list[dict] = [
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "(mensajeria:send_to +objective; el motor sigue la gestión); una cita o un mensaje "
                "(widget_data: la agenda ES el calendario); MOSTRAR lo que YA existe (show_widget); "
                "vídeo/música/podcast (play_video/play_music); enseñar FOTOS (show_images). "
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "'apps' (lista/catálogo de apps, aplicaciones o widgets: de sistema Y suyos/custom). "
