...
CREDENTIALS = [
    ...
    {"key": "inworld", "env": ["INWORLD_API_KEY"], "enables": "TTS Inworld (nube, titular · V2-774)",
     "profiles": ["cloud"]},
    {"key": "elevenlabs", "env": ["ELEVENLABS_API_KEY"], "enables": "TTS ElevenLabs (nube, segunda opción)",
     "profiles": ["cloud"]},
