...
MANIFEST_VERSION = 17   # 2026-09-22: V2-750 — the model row says WHICH model fell and WHICH one is
                        # answering, in two lines and two colours (three new `status.llm_*` strings)
