...
DOMAINS: list[dict] = [
    ...
    {"id": "2", "name": "FLASHBRAIN (nucleo)", "nodes": [
        ...
        {"id": "2.5", "title": "Escalado / dispatch / workers", "ch": UNIT, "paths": [
            ...
            "tests/agent_headless/unit/workers/test_the_workers_shell_is_bash.py",
        ...
        {"id": "4.56", "title": "«Hecho.» solo si la data-op OCURRIÓ · y lo que el widget rechaza se DICE",
            ...
            "paths": ["tests/agent_headless/unit/flash/test_hecho_sobre_una_op_que_fallo.py",
                      ...
                      # V2-469: los enlaces pegados viajan TODOS al add, y la enumeración marca «la que suena».
                      "tests/agent_headless/unit/flash/test_the_pasted_links_all_travel.py"]},
    ...
    {"id": "3", "name": "VOZ", "nodes": [
        ...
        {"id": "3.58", "title": "Jev names the request type before the deadline; the cover matches it or the regex stands",
        ...
        # que probaba el mapeo y nunca el cableado, y el único que tocaba la puerta real asertaba `is None`, que
        # es justo lo que devolvía el bug. Este nodo es la clase que faltaba: falsea el TRANSPORTE y asserta que
        # hubo llamada. Desde A5 lleva además el CENSO (las integraciones vivas son exactamente cuatro: una que
        # enmudece y una que aparece sin declararse son el mismo §3.1) y la guarda de que la ruta cancelada
        # sigue fuera del motor — el nodo 3.60 y su fichero desaparecieron con ella. Más el trinquete de las
        # llamadas BLOQUEANTES (`choose_sync` congela el event loop del turno de voz), congeladas en dos.
    ...
    {"id": "4", "name": "WIDGETS", "nodes": [
        ...
        {"id": "4.219", "title": "MAPA: los sitios por nombre y ciudad se geolocalizan aquí (con relevo), uno que "
            ...
            "ch": UNIT, "paths": [
                "tests/browser/unit/map/test_places_are_located_and_pinned.py",
                "tests/browser/e2e/widgets/test_map_render.py"]},
        ...
        {"id": "2.75", "title": "Un número que ÉL ha dicho no es una invención — repetir una búsqueda no "
            ...
            "ch": UNIT,
            "paths": ["tests/voice/unit/test_a_number_he_said_is_not_an_invention.py"]},
        {"id": "2.74", "title": "«Vale, para el vídeo» es una PAUSA, una orden de reproducir trae la cara "
                                "del reproductor, y el arnés no declara VACÍA una tarjeta que no ha "
                                "verificado",
            "ch": UNIT,
            "paths": ["tests/voice/unit/test_an_order_to_play_shows_the_player.py"]},
        ...
        {"id": "4.117", "title": "«Sal de pantalla completa» no necesita nombre: el canvas informa de QUÉ tarjeta está maximizada, el prompt lo dice y `widget_id` deja de ser obligatorio — y con NADA a pantalla completa el resolutor no elige widget (un interruptor lo METERÍA en pantalla completa)",
         "ch": UNIT, "paths": ["tests/browser/unit/widgets/test_leaving_fullscreen_needs_no_name.py"]},
    ...
    {"id": "5", "name": "CONECTORES", "nodes": [
        ...
        {"id": "5.21", "title": "The communications archive: the one copy that does not expire (V2-628 F0-F3)",
            "ch": UNIT, "paths": ["tests/connectors/unit/messaging/test_archive.py",
                                  "tests/browser/unit/mensajeria/test_search_archive.py",
                                  "tests/connectors/unit/messaging/test_digest.py",
                                  "tests/browser/unit/mensajeria/test_chat_digest.py"]},
    ...
    {"id": "6", "name": "CLUSTER (meshkore)", "nodes": [
        ...
        {"id": "6.2", "title": "Seguridad del canal", "ch": PEER, "paths": [
            ...
            "tests/cluster/unit/test_rebind_residual_get.py"]},
    ...
    {"id": "10", "name": "CASOS DE USO (el arnés que mide el producto)", "nodes": [
        ...
        {"id": "10.120", "title": "Cada reproductor guarda su lista a SU manera — leerlos igual inventa una ronda "
                                  "vacía",
            "ch": UNIT,
            "paths": ["tests/use_cases/unit/test_each_player_stores_its_list_its_own_way.py"]},
