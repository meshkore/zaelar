...
def run():
    ...
    # V2-743 — a CLOCK, not an iteration count: `range(60)` reads as thirty seconds and is not, because the
    # budget counts iterations and an iteration costs whatever it costs.
